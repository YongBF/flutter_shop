...
class CategoryDataModel {
  ...
  List<CategoryMallModel> bxMallSubDto;
  Null comments;
  String image;
  ...
  CategoryDataModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['bxMallSubDto'] != null) {
      bxMallSubDto = new List<CategoryMallModel>();
      json['bxMallSubDto'].forEach((v) {
        bxMallSubDto.add(new CategoryMallModel.fromJson(v));
      });
    }
...
class CategoryMallModel {
  ...
  CategoryMallModel.fromJson(Map<String, dynamic> json) {
